...
<template>
  ...
  <div class="mt-8 relative">
    <div
      class="inline-block relative left-2/4 -translate-x-2/4 lg:absolute lg:left-0 lg:-translate-x-full lg:-ml-6 mb-6 ">
      <div class="flex space-x-1 p-1 text-center rounded-xl bg-blue-200/20 text-xs md:text-sm lg:flex-col shadow-inner">
